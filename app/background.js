...
function createWindow(windowName, options) {
  ...
  var store = new (electron_store__WEBPACK_IMPORTED_MODULE_12___default())({
    name: name
  });
  var defaultSize = {
    width: options.width,
  ...
  var resetToDefaults = function resetToDefaults() {
    var bounds = electron__WEBPACK_IMPORTED_MODULE_11__.screen.getPrimaryDisplay().bounds;
  ...
  var ensureVisibleOnSomeDisplay = function ensureVisibleOnSomeDisplay(windowState) {
    ...
    var visible = _babel_runtime_corejs3_core_js_stable_instance_some__WEBPACK_IMPORTED_MODULE_10___default()(_context = electron__WEBPACK_IMPORTED_MODULE_11__.screen.getAllDisplays()).call(_context, function (display) {
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 8:
          port = process.argv[2];
          _context.next = 11;
          return mainWindow.loadURL("http://localhost:".concat(port, "/home"));
